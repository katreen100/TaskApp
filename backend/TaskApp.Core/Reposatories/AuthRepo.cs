...
namespace TaskApp.Core.Reposatories
{
    public class AuthRepo
    {
        ...
        public AuthRepo(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt)
        {
         ...
         public async Task<AuthModel> RegisterAsync(Rigester model)
        {
